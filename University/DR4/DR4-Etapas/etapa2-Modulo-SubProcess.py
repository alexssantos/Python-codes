...
''' OBS da aula:
    ...
    - Python Précompila o codigo/bibliotecas/arquivos etranspormando em microcodigo (pycache). Inclusive há Engines em outras linguas para usar esse microcodigos em outras plataformas, como o 
        IronPython para C#. 
    - Processo 'SYstem Idle'(ocioso): o processo de pid '0'. Ele é usado pelo sistema para manter o hardware (processador) trabalhando e economizar 
        energia conforme o uso dos processos pelo processador. Ele tem prioridade mínima.
    - Os processos são numerados (pid) e a ordem de chamada/numeração são gerenciadas totalmente pelo sistema operacional. 
                                '''
...
# TP1-QST10: Diferenças entre spawn e exec:  
